...
3. Move arrow to to perform your experiment.`
        ...
        {/* {authContext && authContext.} */}
        <List.Section title="Physics Lab Experiments" style={{ gap: 5 }}>
          <List.Accordion title="Chapter-1    Matter around us">
            <List.Item
              title="Observing the types of images & measuring of object distances"
              onPress={(e) =>
                LabHandler(
...
3. Move arrow to to perform your experiment.`
          ...
          <List.Accordion title="Chapter-2    Motion">
            <List.Item title="Activity - Formation of Barium Sulphate Precipitate" />
            <List.Item
              title="Refraction Experiment"
              onPress={(e) =>
          ...
          <List.Accordion title="Chapter-3    Laws of motion">
            <List.Item title="Balancing Chemical Equations" />
            <List.Item title="Neutralization " 
                onPress = { (e)=>LabHandler("https://javalab.org/en/neutralization_reaction_en/")}
            />
          ...
          <List.Accordion title="Chapter-4    Refraction Of Light At Plane Surfaces">
          ...
          <List.Accordion title="Chapter-5    Gravitation">
            <List.Item
              title="Experiment - Finding Refractive Index Of Prism"
              onPress={(e) =>
                LabHandler(
          ...
          <List.Accordion title="Chapter-6    Is matter pure">
            <List.Item
              title="Shape Of ElectroMagnetic Wave - 3D"
              onPress={(e) =>
                LabHandler(
          ...
          <List.Accordion title="Chapter-7    Atoms and molecules and chemical reactions">
            {/* <List.Item title="Electric Motor" />
            <List.Item title="Electric Generator" onPress={LabHandler} />
            <List.Item title="Solenoid" /> */}
          </List.Accordion>

          <List.Accordion title="Chapter-8    Floating Bodies">
            {/* <List.Item title="Electric Motor" />
            <List.Item title="Electric Generator" onPress={LabHandler} />
            <List.Item title="Solenoid" /> */}
          </List.Accordion>

          <List.Accordion title="Chapter-9    What is inside atom">
            {/* <List.Item title="Electric Motor" />
            <List.Item title="Electric Generator" onPress={LabHandler} />
            <List.Item title="Solenoid" /> */}
          </List.Accordion>

          <List.Accordion title="Chapter-10    Work and Energy">
            {/* <List.Item title="Electric Motor" />
            <List.Item title="Electric Generator" onPress={LabHandler} />
            <List.Item title="Solenoid" /> */}
          </List.Accordion>

          <List.Accordion title="Chapter-11    Heat">
            {/* <List.Item title="Electric Motor" />
            <List.Item title="Electric Generator" onPress={LabHandler} />
            <List.Item title="Solenoid" /> */}
          </List.Accordion>

          <List.Accordion title="Chapter-12    Sound">
            {/* <List.Item title="Electric Motor" />
            <List.Item title="Electric Generator" onPress={LabHandler} />
            <List.Item title="Solenoid" /> */}
          </List.Accordion>
